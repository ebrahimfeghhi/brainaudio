...
# --- GRU B2T '24 ---
gru_24_original = np.array([0.141557, 0.138282, 0.142831, 0.145924, 0.140284,
                             0.141557, 0.142649, 0.141557, 0.141739, 0.139010])
gru_24_shared   = np.array([0.1743, 0.1801, 0.1772, 0.1788, 0.1743,
                             0.1764, 0.1786, 0.1728, 0.1710, 0.1719])

# --- GRU B2T '25 ---
gru_25_original = np.array([0.0641, 0.0632, 0.0635, 0.0626, 0.0638,
                             0.0630, 0.0678, 0.0644, 0.0620, 0.0619])
gru_25_shared   = np.array([0.0819, 0.0915, 0.0836, 0.0884, 0.0836,
                             0.0880, 0.0832, 0.0859, 0.0827, 0.0840])
