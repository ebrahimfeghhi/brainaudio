...
FINAL_MODEL_PATH = os.path.join(OUTPUT_DIR, f"{MODEL_NAME}_final_lora_{YEAR}_seed_{SEED}")
#FINAL_MODEL_PATH = os.path.join(OUTPUT_DIR, f"{MODEL_NAME}_final_lora_combined")

TEST_DATA_PATH = f"./jsonl_files/test_{YEAR}.jsonl"
OUTPUT_TXT_PATH = f"generative_results/test_predictions_{YEAR}_{MODEL_NAME}_seed_{SEED}.txt"
