...
train_data_files = f"./jsonl_files/train_b2t_24_wfst_{MODE}.jsonl" if YEAR == "b2t_24" else f"./jsonl_files/train_b2t_25_wfst_{MODE}.jsonl"
val_data_files = f"./jsonl_files/val_b2t_24_wfst_{MODE}.jsonl" if YEAR == "b2t_24" else f"./jsonl_files/val_b2t_25_wfst_{MODE}.jsonl"
...
if __name__ == "__main__":
    ...
    final_save_path = os.path.join(OUTPUT_DIR, f"{model_shortname}_final_lora_{YEAR}_wfst_{MODE}_seed_{SEED}")
